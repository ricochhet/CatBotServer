...
openFile = [ [value if len(value) >= 1 and value != '–' else '-' for value in line.split(u'\u0009')] for line in openFile][1:]


lineObjects = []
keyValues = ['largeMonster','ke','bodyPart','state','slash','blunt','ranged','fire','water','thunder','ice','dragon','stun','flinch','trip','timer','wound','sever','notes']    
