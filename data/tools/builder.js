...
const csv = require('../libs/csvToJson');
...
class Build {
  ...
  async buildWeapons(writeTo, advanced) {
    const weaponsDatabase = require('../src/json/weapons/weapons.json');
  ...
  async buildWeaponsAPI(writeTo, advanced) {
  ...
  // Creates an object and then writes that object to a specified file
  async buildItems(writeTo) {
    const itemsAPIDatabase = await this.getData(itemsURL);
    const itemsData = require('../src/json/items/items.json');
  ...
  async buildDecorations(writeTo, advanced) {
  ...
  // Creates an object and then writes that object to a specified file
  async buildSkills(writeTo, advanced) {
  ...
  // Creates an object and then writes that object to a specified file
  async buildArmors(writeTo, advanced) {
  ...
  // Creates an object and then writes that object to a specified file
  async buildArmorPieces(writeTo, advanced) {
