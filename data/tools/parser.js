...
class Parser {
  parseArmorPieces(writeTo) {
    const armor_base = require('../src/source_json/armors/armor_base.json');
    const armor_craft_ext = require('../src/source_json/armors/armor_craft_ext.json');
    const armor_skills_ext = require('../src/source_json/armors/armor_skills_ext.json');
    const skill_levels = require('../src/source_json/skills/skill_levels.json');
  ...
  parseArmors(writeTo) {
    const armorset_base = require('../src/source_json/armors/armorset_base.json');
    const armor_pieces = require('../src/json/armors/armor_pieces.json');
    const armorset_bonus_base = require('../src/source_json/armors/armorset_bonus_base.json');
    const skill_levels = require('../src/source_json/skills/skill_levels.json');
  ...
  parseCharms(writeTo) {
    const charm_base = require('../src/source_json/charms/charm_base.json');
  ...
  parseDecorations(writeTo, nop) {
    const decoration_base = require('../src/source_json/decorations/decoration_base.json');
    const skill_levels = require('../src/source_json/skills/skill_levels.json');
  ...
  parseItems(writeTo) {
    const item_base = require('../src/source_json/items/item_base.json');
    const item_combination_list = require('../src/source_json/items/item_combination_list.json');
    const location_items = require('../src/source_json/locations/location_items.json');
  ...
  parseMonsters(writeTo) {
    const monster_base = require('../src/source_json/monsters/monster_base.json');
    const monster_breaks = require('../src/source_json/monsters/monster_breaks.json');
    const monster_hitzones = require('../src/source_json/monsters/monster_hitzones.json');
    const monster_ailments = require('../src/source_json/monsters/monster_ailments.json');
    const monster_habitats = require('../src/source_json/monsters/monster_habitats.json');
    const monster_rewards = require('../src/source_json/monsters/monster_rewards.json');
    const monster_weaknesses = require('../src/source_json/monsters/monster_weaknesses.json');
  ...
  parseQuests(writeTo) {
    const quest_base = require('../src/source_json/quests/quest_base.json');
    const quest_monsters = require('../src/source_json/quests/quest_monsters.json');
    const quest_rewards = require('../src/source_json/quests/quest_rewards.json');
  ...
  parseSkills(writeTo) {
    const skill_base = require('../src/source_json/skills/skill_base.json');
    const skill_levels = require('../src/source_json/skills/skill_levels.json');
  ...
  parseKinsects(writeTo) {
    const kinsect_base = require('../src/source_json/weapons/kinsect_base.json');
    const kinsect_craft_ext = require('../src/source_json/weapons/kinsect_craft_ext.json');
  ...
  parseWeapons(writeTo) {
    const weapon_base = require('../src/source_json/weapons/weapon_base.json');
    const weapon_ammo = require('../src/source_json/weapons/weapon_ammo.json');
    const weapon_bow_ext = require('../src/source_json/weapons/weapon_bow_ext.json');
    const weapon_craft = require('../src/source_json/weapons/weapon_craft.json');
    const weapon_sharpness = require('../src/source_json/weapons/weapon_sharpness.json');
