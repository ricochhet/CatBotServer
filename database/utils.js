...
class ChunkUtil {
  ...
  convert() {
    const datatypes = {
      armors: './database/source_data/armors',
      charms: './database/source_data/charms',
      decorations: './database/source_data/decorations',
      items: './database/source_data/items',
      locations: './database/source_data/locations',
      monsters: './database/source_data/monsters',
      quests: './database/source_data/quests',
      skills: './database/source_data/skills',
      weapons: './database/source_data/weapons'
    };
    ...
    fs.readdir(datatypes.armors, (err, files) => {
      ...
      files.forEach(file => {
        ...
        this.write({
          ...
          output: `./database/source_json/armors/${name}.json`
        });
      });
    });
    ...
    fs.readdir(datatypes.charms, (err, files) => {
      ...
      files.forEach(file => {
        ...
        this.write({
          ...
          output: `./database/source_json/charms/${name}.json`
        });
      });
    });
    ...
    fs.readdir(datatypes.decorations, (err, files) => {
      ...
      files.forEach(file => {
        ...
        this.write({
          ...
          output: `./database/source_json/decorations/${name}.json`
        });
      });
    });
    ...
    fs.readdir(datatypes.items, (err, files) => {
      ...
      files.forEach(file => {
        ...
        this.write({
          ...
          output: `./database/source_json/items/${name}.json`
        });
      });
    });
    ...
    fs.readdir(datatypes.locations, (err, files) => {
      ...
      files.forEach(file => {
        ...
        this.write({
          ...
          output: `./database/source_json/locations/${name}.json`
        });
      });
    });
    ...
    fs.readdir(datatypes.monsters, (err, files) => {
      ...
      files.forEach(file => {
        ...
        this.write({
          ...
          output: `./database/source_json/monsters/${name}.json`
        });
      });
    });
    ...
    fs.readdir(datatypes.quests, (err, files) => {
      ...
      files.forEach(file => {
        ...
        this.write({
          ...
          output: `./database/source_json/quests/${name}.json`
        });
      });
    });
    ...
    fs.readdir(datatypes.skills, (err, files) => {
      ...
      files.forEach(file => {
        ...
        this.write({
          ...
          output: `./database/source_json/skills/${name}.json`
        });
      });
    });
    ...
    fs.readdir(datatypes.weapons, (err, files) => {
      ...
      files.forEach(file => {
        ...
        this.write({
          ...
          output: `./database/source_json/weapons/${name}.json`
        });
      });
    });
  }
